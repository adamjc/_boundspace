package Enemies.AsteroidShooter 
{
	 ...
	 * @author ...
	 */
	public class AsteroidShooter extends Enemy 
	{
		[Embed (source = "../../../assets/units/asteroid-shooter.png")] protected var asteroidShooterSprite:Class;		
		...
		public function AsteroidShooter(_ai:Boolean = true, _x:Number = 0, _y:Number = 0) 
		{		
			...
			// used for weapons!
			image = loadGraphic(asteroidShooterSprite);							
			...
			var graphic:FlxSprite = loadGraphic(asteroidShooterSprite);		
			
			if (_ai)
			{
				var self:AsteroidShooter = this;
				startTelprot(this, function():void {
					self.ai = new AsteroidShooterAI(self);
